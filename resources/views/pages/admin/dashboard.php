                ...
                <div class="rounded-lg bg-slate-100 p-4 dark:bg-navy-600">
                    <div class="flex justify-between space-x-1">
                        <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                            <?= $data['statisticalProduct']['product'] ?>
                        </p>
                    ...
                    <p class="mt-1 text-xs+">Sản phẩm</p>
                </div>
                <div class="rounded-lg bg-slate-100 p-4 dark:bg-navy-600">
                    <div class="flex justify-between">
                        <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                            <?= $data['statisticalCategory']['category'] ?>
                        </p>
                    ...
                    <p class="mt-1 text-xs+">Danh mục</p>
                </div>
                <div class="rounded-lg bg-slate-100 p-4 dark:bg-navy-600">
                    <div class="flex justify-between">
                        <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                            <?= $data['statisticalUser']['user'] ?>
                        </p>
                    ...
                    <p class="mt-1 text-xs+">Người dùng</p>
                </div>
                <div class="rounded-lg bg-slate-100 p-4 dark:bg-navy-600">
                    <div class="flex justify-between">
                        <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
                            <?= $data['statisticalView']['view'] ?>
                        </p>
                    ...
                    <p class="mt-1 text-xs+">Lượt truy cập</p>
                </div>
            </div>
                                ...
                                <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        <div class="badge bg-warning/10 text-warning dark:bg-warning/15">
                                            <?= $user['is_delete'] === 0 ? 'Hoạt động' : 'Không hoạt động' ?>
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
